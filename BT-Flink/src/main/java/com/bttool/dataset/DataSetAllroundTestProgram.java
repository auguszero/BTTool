...
public class DataSetAllroundTestProgram {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<Tuple2<String, Integer>> x2Keys = env.createInput(Generator.generate(numKeys * 1, 2,"x2keys")).setParallelism(1);
		DataSet<Tuple2<String, Integer>> x8Keys = env.createInput(Generator.generate(numKeys, 8,"x8Keys")).setParallelism(1);

		if (infinite) {
			x1Keys = env.createInput(Generator.generateInfinitely(numKeys,"x1Keys")).setParallelism(1);
		} else {
			x1Keys = env.createInput(Generator.generate(numKeys, 1,"x1Keys")).setParallelism(1);
		}
